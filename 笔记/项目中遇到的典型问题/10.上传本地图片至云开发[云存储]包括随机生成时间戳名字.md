...
https://ke.qq.com/course/1712225?taid=7953523519660129

# html

```javascript
<!--pages/img/img.wxml-->
<image class="image_cl" src="{{newSrc}}" mode="widthFix" lazy-load="false" binderror="" bindload="">  
</image>
<button id="btn" bindtap="upImage">上传图片</button>
```
