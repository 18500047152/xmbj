...
/* 13 */
/*!*******************************************************************************!*\
  !*** D:/qmm/jidianguanli_app/节点量子系统/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*******************************************************************************/
...
/* 14 */
/*!************************************************************!*\
  !*** D:/qmm/jidianguanli_app/节点量子系统/pages/index/index.vue ***!
  \************************************************************/
/*! no static exports found */
...
/* 15 */
/*!*******************************************************************************************!*\
  !*** D:/qmm/jidianguanli_app/节点量子系统/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*******************************************************************************************/
...
/* 16 */
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/qmm/jidianguanli_app/节点量子系统/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var f0 = _vm._f("numFilter")(_vm.pointBusCount.gmv)

  var f1 = _vm._f("numFilter")(_vm.pointBusCount.total_money)

  var f2 = _vm._f("numFilter")(_vm.pointBusCount.user_total_money)
...
/* 17 */
/*!*************************************************************************************!*\
  !*** D:/qmm/jidianguanli_app/节点量子系统/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 18 */
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/qmm/jidianguanli_app/节点量子系统/pages/index/index.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _API = __webpack_require__(/*! pages/common/API.js */ 8); //
//
//
//
//
...
//
//
var Head = function Head() {__webpack_require__.e(/*! require.ensure | pages/common/headhome */ "pages/common/headhome").then((function () {return resolve(__webpack_require__(/*! ../common/headhome.vue */ 211));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { Head: Head }, data: function data() {return { // head               
      headTitle: { title: '憨猴OS', color: '#FFF', size: '35.93rpx' }, headOtherIcon: { color: '#FFFFFF', icon: 'icon-wode', size: '45rpx', url: '/pages/my/index' }, headReturn: { status: 'isShow', color: 'white' }, newsIcon: { color: '#FFFFFF', icon: 'icon-wode', size: '45rpx', url: '/pages/news/list' }, have: true, bannerList: [], pointCountInfo: [], pointBusCount: {}, jiaPointBusCount: { total_GMV: 163333.00, total_commission: 14584.00, tatal_money: 1234567.00, jie: 9000, direct: 5000, indirect: 5000 }, // 推广
      isMark: false, otherModel: false };}, onLoad: function onLoad() {var data = uni.getStorageSync('data').token;}, onShow: function onShow() {var data = uni.getStorageSync('data').token;if (data) {this.banner();this.getpointCount();this.getpointBusCount(); // 获取是否有未读信息
      this.getMsg();if (uni.getSystemInfoSync().windowHeight > 680) {this.otherModel = true;}}}, methods: { banner: function banner() {var _this = this;var url = "/api/user/slide";var obj = { token: uni.getStorageSync('data').token };_API.httpRequest_.get(url, obj).then(function (res) {_this.bannerList = res.data.data;});}, getpointCount: function getpointCount() {var _this2 = this;var url = "/api/user_relation/pointUserCount";var obj = { token: uni.getStorageSync('data').token };_API.httpRequest_.get(url, obj).then(function (res) {if (res.code == 1) {_this2.pointCountInfo = res.data;} else {_API.otherAPI.toast(res.msg, 'none', false, 1500);}});}, //这个接口是我的交易接口
    getpointBusCount: function getpointBusCount() {var _this3 = this;var url = "/api/user_relation/gmv";var obj = { token: uni.getStorageSync('data').token };_API.httpRequest_.get(url, obj).then(function (res) {if (res.code == 1) {_this3.pointBusCount = res.data.data;} else {_API.otherAPI.toast(res.msg, 'none', false, 1500);}});}, closeMark: function closeMark() {this.isMark = !this.isMark;}, extensionClick: function extensionClick(param) {var _this4 = this;if (getApp().globalData.navStatus === true) {return false;}getApp().globalData.navStatus = true;uni.navigateTo({ url: '/pages/extension/index?param=' + param + '', success: function success(res) {_this4.isMark = !_this4.isMark;getApp().globalData.navStatus = false;} });}, otherClick: function otherClick(url) {_API.otherAPI.nav(url);}, getMsg: function getMsg() {var _this5 = this;var url = "/api/operation.message/message_type_one_show";var obj = { token: uni.getStorageSync('data').token };_API.httpRequest_.get(url, obj).then(function (res) {if (res.code == 1) {_this5.have = true;} else {_this5.have = false;}});} } };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))

/***/ }),
/* 19 */
/*!*********************************************************************************************!*\
  !*** D:/qmm/jidianguanli_app/节点量子系统/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 20 */
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/qmm/jidianguanli_app/节点量子系统/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
